...
# manual read from tables
intracellular_matter = (I('Cytosol')|I('Nucleus')|I('Nucleolus')|I('Mitochondria')|I('Lysosome')|I('Cellulose')|I('Chitin'))
ionic_liquid = (I('[C2mim][ClI2]')|I('[C2mim][BrI2]')|I('[C4mim][ClI2]')|I('[C4mim][BrI2]')|I('[C4mim][Br3]')|I('[C6mim]I')|I('[C6mim][BrI2]')|I('[C8mim]Br')|I('[C4mim][BF4]')|I('[C4mim][NTf2]')|I('[C4mim][OTf]')|I('[C4mim][NTf2]')|I('[C4mim][NTf2]')|I('[C4mim][OTf]')|I('[C1C1im][(MeO)2PO2]')|I('[C1C4im][(MeO)2PO2]')|I('[C1C6im][(MeO)2PO2]')|I('[C1C1im][MeMeOPO2]')|I('[C1C4im][MeMeOPO2]')|I('[C1C6im][MeMeOPO2]')|I('[C1C1im][MeOHPO2]')|I('[C1C4im][MeOHPO2]')|I('[C1C6im][MeOHPO2]')|I('[BzmIm]Br')|I('[BzmIm][Sac]')|I('[Pp,p,p,6][Sac]')|I('[Pp,p,p,6][Bz–I–SO3]')|I('[Pp,p,p,6][Bz–SO3]')|I('[P4,4,4,4][Sac]')|I('[BmimI2][N(Tf)2]')|I('[C6mim]I')|I('[C4mim][I3]')|I('[C4mim][I5]')|I('[C4mim][I7]')|I('[C2mim][I7]')|I('[C2mim][I9]')|I('[C4mim][OTf]')|I('[AC4Im]DCA')|I('[AC6Im]DCA')|I('[AC8Im]DCA')|I('[AC10Im]DCA')|I('[AC12Im]DCA')|I('[AC14Im]DCA')|I('[AVIm]DCA')|I('[VC8Im]DCA')|I('[VC10Im]DCA')|I('[BMIm]BF426')|I('[BMIm]PF626'))
composition = (I('TiP')|I('TiF')|I('InP')|I('InAs')|I('InSb')|I('TiF')|I('ZnSa')|I('SiNP-PS3')|I('SiNP-PS4a')|I('SiNP-PS5')|I('SiNP-PS6')|I('SiNP-PS3')|I('KTP'))
unresolved_organic = (I('CH222-OH')|I('S-OH')|I('SO222-OH')|I('CH22-OHS')|I('S-OHS')|I('SO22-OHS')|I('PbPc(BunPDMS10)4')|I('[C2-Cl-Morph][TFSI]')|I('[C2-Cl-Pip][TFSI]')|I('[C2-Cl-Pyrr][TFSI]')|I('[HN2-Cl-22][TFSI]')|I('[HN2-Cl-11][TFSI]')|I('[HN3-Cl-11][TFSI]')|I('BST')|I('KNN')|I('PLT')|I('PLZT')|I('PMN–PT')|I('PZT')|I('PZTN5')|I('PHI-6F')|I('PHI-BC')|I('PHI-6FTi10')|I('PHI-6FTi30')|I('PHI-6FTi50')|I('PHI-BCTi50')|I('PHI-6FZr30')|I('PHI-6FZr50')|I('PHI-BCZr50')|I('Mtvs')|I('MtvsNP')|I('Mtvs:dvb11NP')|I('Mtvsdvb12NP')|I('[MoOS3Cu3(4-pic)6]·0.5[Mo2O7]')|I('[WOS3Cu3(4-pic)6]·0.5[W2O7]')|I('[MoOS3Cu3(4-pic)6]·BF4')|I('[WOS3Cu3(4-pic)6]·BF4')|I('[Et4N]2[MoS4Cu4(CN)4]')|I('[MoS4Cu4Br2(py)6]')|I('[WS4Cu4Br2(py)6]')|I('CsCdBr3')|I('[WOS3Cu3I(py)5]')|I('[MoOS3Cu3(4-pic)6]·Br')|I('[WOS3Cu3(4-pic)6]·Br')|I('[Et4N]2[MoS4Cu4(CN)4]')|I('[Et4N]2[WS4Cu4(CN)4]')|I('Benzenee'))
oil_and_water = (I('Diesel') + I('oil')|I('Wax') + I('oil')|I('Linseed') + I('oil')|I('Distilled') + I('water') |I('Deionized') + I('water')|I('Distilled') + I('water')|I('Distilled') + I('water')).add_action(join)
polymers =  (I('hb-PTEPA(Co)')|I('hb-PTEPA(Co)-UV')|I('OMOS-BTEE')|I('OMOS-BTEEY')|I('OMOS-BTEM')|I('C16-IDTBTa')|I('DPP-TT-T-1b')|I('PCDTBTa')|I('PCPDTBTa')|I('rr-P3HTa')|I('PC70BMa'))
...
#cm = cm + Optional(ZeroOrMore((R(r'@')|R(r'/')|W('/')|R(r'[-‐‑⁃‒–—―-−－⁻]')|R(r' '))) + Optional(cm))
core_shell_np = ((cm | element_name | element_symbol | formula) + (slash | hyphen | W('@')|R(r'@')|R(r'/')|W('/')|R(r'[-‐‑⁃‒–—―-−－⁻]')|R(r' ')) + (cm | element_name | element_symbol | formula)).add_action(join)
chemical_name_options = (
    core_shell_np | cm | element_name | element_symbol | registry_number | amino_acid | amino_acid_name | formula | intracellular_matter | ionic_liquid | composition | unresolved_organic | oil_and_water | polymers
)
chemical_name_options = (chemical_name_options  + Optional(ZeroOrMore((R(r'@')|R(r'/')|W('/')|R(r'[-‐‑⁃‒–—―-−－⁻]')|R(r' '))) + Optional(chemical_name_options)))
...
#cem = cem  + Optional(ZeroOrMore((R(r'@')|R(r'/')|W('/')|R(r'[-‐‑⁃‒–—―-−－⁻]')|R(r' '))) + Optional(cem))
...
names_only = Group((cm | solvent_name | chemical_name
