...
class PropertyParserTemplate(BaseAutoParser, BaseSentenceParser):
    ...
    @property
    def prefix(self):
        return (Optional(self.specifier_phrase)
    ...
    @property
    def connection(self):
        return (I('at')|W('=')|I('of')|I('about')|I('for')|I('as') + I('regards')|I('attributed') + I('to')|I('concerning')).add_action(join)
    ...
    def cem_before_specifier_and_value_phrase(self):
        return (
                ...
                +self.specifier_phrase + self.specifier_and_value)('root_phrase')
    ...
    @property
    def root(self):
        root_phrase = (self.cem_specifier_value|self.specifier_cem_value|self.specifier_value_cem|self.value_specifier_cem|self.cem_value_specifier|
