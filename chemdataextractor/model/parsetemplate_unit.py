...
class PropertyParserTemplate_unit(BaseAutoParser, BaseSentenceParser):
    ...
    def specifier_before_cem_and_value_phrase(self):
        return (
                ...
                + self.cem_phrase
                + OneOrMore(Not(self.cem_phrase | self.specifier_phrase | self.value_phrase| I('not')) + Any().hide())
...
class MultiQuantityModelTemplateParser_unit(BaseAutoParser, BaseSentenceParser):
